...
const en = {
  ...
  'home.trust_quality_title': 'Original PDFs',
...
const fr: Record<keyof typeof en, string> = {
  ...
  'home.trust_quality_title': 'PDF originaux',
...
const categoryDescriptionsFr: Record<string, string> = {
  'alarm-security':  "Manuels techniques et guides d'installation pour systèmes d'alarme, détecteurs et équipements de surveillance. PDF.",
  'audio-hifi': "Manuels de réparation pour Bang & Olufsen, Revox, Nagra, Studer, Rock-Ola — amplificateurs, magnétophones, platines, juke-boxes et équipements HiFi. PDF.",
  'autonomy': "Ouvrages de référence sur l'agriculture traditionnelle, l'autonomie alimentaire et la vie rurale. PDF téléchargeables.",
  'automotive': "Manuels d'atelier pour Renault, Peugeot, BMW, Toyota, Honda, Harley-Davidson — voitures, motos, quads et véhicules utilitaires. PDF.",
  'biomedical': "Manuels de service pour Schiller, Siemens, Dräger, KaVo, Welch-Allyn — dispositifs médicaux, dentaire et instruments biomédicaux. PDF.",
  'camping-rv': "Documentation technique pour caravanes, camping-cars et équipements de camping. PDF téléchargeables.",
  'cinema-video': "Manuels de service pour Arriflex, Beaulieu, Bolex, Sony, Panasonic — caméras film, projecteurs 8mm/16mm, caméras vidéo et équipements cinéma. PDF.",
  'computers-it': "Manuels de service pour HP, Dell, Toshiba, Acer, Lenovo, Epson — ordinateurs portables, imprimantes et équipements informatiques. PDF.",
  'diy-home-improvement': "Guides DIY et manuels techniques pour bricolage, machines à coudre Singer, domotique Delta Dore et réparation générale. PDF.",
  'drones': "Manuels de service et guides de réparation pour drones DJI et grand public. PDF téléchargeables.",
  'electronics': "Manuels de service pour Fluke, Tektronix, Hameg, HP, Metrix — oscilloscopes, multimètres et instruments de mesure électronique. PDF.",
  'heating-cooling': "Manuels de service pour Webasto, Eberspächer, Airflam — chauffages autonomes, chauffages à fioul et systèmes de climatisation. PDF.",
  'home-appliances': "Manuels de service pour De'Longhi, Rowenta, Brandt, Krups, Whirlpool — machines à café, chauffages, lave-linge et électroménager. PDF.",
  'machine-tools': "Manuels de service pour Robland, KITY, Bridgeport, Deckel, Myford — machines à bois, tours mécaniques, fraiseuses et machines-outils métal. PDF.",
  'machining': "Guides techniques et ouvrages de référence pour l'usinage de précision, tournage et fraisage des métaux. PDF.",
  'marine': "Manuels techniques pour moteurs marins Volvo Penta, systèmes embarqués et équipements nautiques. PDF.",
  'nature': "Ouvrages de référence sur la nature, l'environnement et les sciences naturelles. PDF téléchargeables.",
  'outdoor-power': "Manuels de service pour Stihl, Honda, Briggs & Stratton, Murray — tronçonneuses, tondeuses, débroussailleuses et motoculture. PDF.",
  'pet-care': "Manuels techniques et ouvrages de référence pour équipements et accessoires de soins animaliers. PDF.",
  'phones-telecom': "Manuels de service pour Nokia, Samsung, Siemens, Gigaset, Jabra — téléphones mobiles, DECT et équipements télécom. PDF.",
  'photography': "Manuels de service pour Nikon, Canon, Leica, Rollei, Hasselblad, Minolta — appareils photo, objectifs, flashs et équipements photo. PDF.",
  'radio-communications': "Manuels de service pour Kenwood, Yaesu, Icom, Grundig, Baofeng — radioamateur, CB, radio marine et télécommunications. PDF.",
  'society-culture': "Ouvrages de référence sur la société, la culture, le développement personnel et les sciences humaines. PDF.",
  'sports-equipment': "Manuels techniques pour robots de tennis de table et équipements d'entraînement sportif. PDF.",
  'television': "Manuels de service pour Sony, Philips, Panasonic, Toshiba, Vestel — téléviseurs, moniteurs et équipements d'affichage. PDF.",
