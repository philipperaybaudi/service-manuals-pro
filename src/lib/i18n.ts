...
const categoryDescriptionsFr: Record<string, string> = {
  ...
  'machine-tools': "Manuels de service pour Robland, KITY, EMCO, Axminster, Felder — scies circulaires, dégauchisseuses, tours à bois et machines combinées. Schémas et listes de pièces PDF.",
  'camping-rv': "Documentation technique pour caravanes, camping-cars et équipements de camping",
  'cinema-video': "Manuels de service pour Arriflex, Beaulieu, Bell Howell, Bolex — projecteurs 8mm/16mm, caméras cinéma et équipements de tournage. PDF téléchargeables.",
  ...
  'audio-hifi': "Manuels de réparation pour Bang & Olufsen, Revox, Nagra, Accuphase, Kenwood — amplificateurs, magnétophones, platines vinyle et tuners. Documentation technique PDF.",
