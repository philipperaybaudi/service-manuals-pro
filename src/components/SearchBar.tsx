...
export default function SearchBar({ large, placeholder, defaultValue = '', locale = 'en' }: SearchBarProps) {
  return (
    <form action="/" method="get" className="w-full">
      <div className="relative">
        ...
        <input
          ...
          placeholder={placeholder || tr(locale, 'search.placeholder')}
          style={{ color: '#111827' }}
