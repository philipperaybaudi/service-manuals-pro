// Import Lot 8 — 4 docs LUREM $10
// Preview : pleine page (800px, sans crop)
// Usage: node scripts/import-lurem-lot-8.mjs
...
const docs = [
  {
    file: 'LUREM Solo 4 Instal Schemas $10.pdf',
    title: 'LUREM Solo 4 — Installation and Wiring Diagrams',
    slug: 'lurem-solo4-installation-schemas',
    overlayTitle: 'Lurem Solo 4 — Installation and Wiring Diagrams',
    price: 1000,
    description: 'Installation guide and wiring diagrams for the LUREM Solo 4 woodworking machine. Covers electrical connection, motor wiring and installation procedures.',
    seoDesc: 'Download the Lurem Solo 4 Installation and Wiring Diagrams. Complete guide for electrical connection, motor wiring and installation of the Solo 4 woodworking machine.',
  },
  {
    file: 'LUREM RD 26 F Notice $10.pdf',
    title: 'LUREM RD 26F — Technical Manual',
    slug: 'lurem-rd26f-technical-manual',
    overlayTitle: 'Lurem RD 26F — Technical Manual',
    price: 1000,
    description: 'Technical manual for the LUREM RD 26F surface planer and thicknesser. Covers installation, adjustments, operation and maintenance. Ref. 23-02-071-00.',
    seoDesc: 'Download the Lurem RD 26F Technical Manual. Complete guide for installation, adjustments, operation and maintenance of the RD 26F surface planer and thicknesser.',
  },
  {
    file: 'LUREM Former RD30 RD26 Notice $10.pdf',
    title: 'LUREM Former RD30 / RD26 — Operating Instructions',
    slug: 'lurem-former-rd30-rd26-notice',
    overlayTitle: 'Lurem Former RD30 / RD26 — Operating Instructions',
    price: 1000,
    description: 'Operating instructions for the LUREM Former RD30 and RD26 surface planers and thicknessers. Covers setup, adjustments, operation and maintenance.',
    seoDesc: 'Download the Lurem Former RD30 / RD26 Operating Instructions. Complete guide for setup, adjustments, operation and maintenance of the Former RD30 and RD26 surface planers.',
  },
  {
    file: 'LUREM Optimake $10.pdf',
    title: 'LUREM Optimake — Technical Manual',
    slug: 'lurem-optimake-manual',
    overlayTitle: 'Lurem Optimake — Technical Manual',
    price: 1000,
    description: 'Technical manual for the LUREM Optimake woodworking machine. Covers setup, tooling, operation and maintenance techniques.',
    seoDesc: 'Download the Lurem Optimake Technical Manual. Complete guide for setup, tooling, operation and maintenance of the Lurem Optimake woodworking machine.',
  },
];

async function run() {
  console.log('=== Import LUREM Lot 8 — 4 docs $10 ===\n');
