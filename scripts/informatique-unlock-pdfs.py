"""
informatique-unlock-pdfs.py — Phase 0 : déverrouillage PDFs Informatique
Supprime les owner passwords sans connaître le mot de passe (pikepdf).
"""
import sys
from pathlib import Path

SOURCE_DIR = Path(r'C:\Users\adm\Documents\SHEMATHEQUE\DOSSIER SOURCE\Catégories\Informatique')
...
print(f'\n{"="*60}')
print(f'  INFORMATIQUE — PHASE 0 DÉVERROUILLAGE ({len(all_pdfs)} PDFs)')
print(f'{"="*60}\n')
...
for pdf_path in all_pdfs:
    ...
    try:
        ...
        print(f'  ✗ USER PASSWORD requis : {rel}')
