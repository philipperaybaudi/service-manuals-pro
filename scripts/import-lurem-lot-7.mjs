// Import Lot 7 — 5 docs LUREM $12
// Preview : pleine page (800px, sans crop)
// Usage: node scripts/import-lurem-lot-7.mjs
...
const docs = [
  {
    file: 'LUREM C2100 Eclate $12.pdf',
    title: 'LUREM C2100 — Parts Overview',
    slug: 'lurem-c2100-parts-overview',
    overlayTitle: 'Lurem C2100 — Parts Overview',
    price: 1200,
    description: 'Parts overview for the LUREM C2100 combination woodworking machine, with machine illustration. Ref. 230300100.',
    seoDesc: 'Download the Lurem C2100 Parts Overview. Complete parts reference with machine illustration for the C2100 combination woodworking machine. Ref. 230300100.',
  },
  {
    file: 'LUREM C210B Eclate $12.pdf',
    title: 'LUREM C210B — Instructions Manual',
    slug: 'lurem-c210b-instructions',
    overlayTitle: 'Lurem C210B — Instructions Manual',
    price: 1200,
    description: 'Instructions manual for the LUREM C210B combination woodworking machine. Covers setup, adjustments and operating procedures. Ref. 230200100.',
    seoDesc: 'Download the Lurem C210B Instructions Manual. Complete guide for setup, adjustments and operation of the C210B combination woodworking machine. Ref. 230200100.',
  },
  {
    file: 'LUREM C200 210 260 Notice $12.pdf',
    title: 'LUREM C200 / C210 / C260 — Operators Notice',
    slug: 'lurem-c200-c210-c260-notice',
    overlayTitle: 'Lurem C200 / C210 / C260 — Operators Notice',
    price: 1200,
    description: 'Operators notice covering the LUREM C200, C210 and C260 combination woodworking machines. Covers setup, adjustments and operating procedures.',
    seoDesc: 'Download the Lurem C200 / C210 / C260 Operators Notice. Setup, adjustments and operating procedures for the C200, C210 and C260 combination woodworking machines.',
  },
  {
    file: 'LUREM C210B Notice $12.pdf',
    title: 'LUREM C210B — Notice',
    slug: 'lurem-c210b-notice',
    overlayTitle: 'Lurem C210B — Notice',
    price: 1200,
    description: 'Early operators notice for the LUREM C210B combination woodworking machine. Covers installation, adjustments and operating procedures.',
    seoDesc: 'Download the Lurem C210B Operators Notice. Early edition covering installation, adjustments and operating procedures for the C210B combination woodworking machine.',
  },
  {
    file: 'LUREM C7 compact 7 Notice $12.pdf',
    title: 'LUREM Compact 7 — Technical Notice',
    slug: 'lurem-compact7-notice',
    overlayTitle: 'Lurem Compact 7 — Technical Notice',
    price: 1200,
    description: 'Technical notice for the LUREM Compact 7 combination woodworking machine. Includes specifications for the jointer, thicknesser, table saw and spindle moulder sections.',
    seoDesc: 'Download the Lurem Compact 7 Technical Notice. Complete specifications and operating information for the Compact 7 combination woodworking machine.',
  },
];

async function run() {
  console.log('=== Import LUREM Lot 7 — 5 docs $12 ===\n');
