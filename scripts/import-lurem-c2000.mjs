// Import LUREM C2000 $25 — oublié du Lot 3
// Preview : pleine page (800px, sans crop)
// Usage: node scripts/import-lurem-c2000.mjs
...
const doc = {
  ...
  title: 'LUREM C2000 — Technical Manual',
  slug: 'lurem-c2000-technical-manual',
  overlayTitle: 'Lurem C2000 — Technical Manual',
  price: 2500,
  description: 'Technical manual for the LUREM C2000 combination woodworking machine. Covers installation, adjustments, operation and maintenance. Ref. 232900100.',
  seoDesc: 'Download the Lurem C2000 Technical Manual. Complete guide for installation, adjustments, operation and maintenance of the C2000 combination woodworking machine. Ref. 232900100.',
};

async function run() {
  console.log('=== Import LUREM C2000 $25 ===\n');
  ...
  try {
    ...
    if (prevErr) { console.warn('   ⚠ Preview upload:', prevErr.message); return; }
    ...
    if (docErr) { console.error('   ✗ DB:', docErr.message); return; }
