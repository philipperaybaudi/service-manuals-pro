// Extract cover pages of Lot 7 — 5 docs LUREM $12
...
const OUT = 'C:/Users/adm/Claude Doc GB test/service-manuals-pro/tmp-lurem-previews/lot-7';

if (!existsSync(OUT)) mkdirSync(OUT, { recursive: true });

const PDFS = [
  { file: 'LUREM C2100 Eclate $12.pdf',         out: '01-c2100-eclate.jpg' },
  { file: 'LUREM C210B Eclate $12.pdf',         out: '02-c210b-eclate.jpg' },
  { file: 'LUREM C200 210 260 Notice $12.pdf',  out: '03-c200-210-260-notice.jpg' },
  { file: 'LUREM C210B Notice $12.pdf',         out: '04-c210b-notice.jpg' },
  { file: 'LUREM C7 compact 7 Notice $12.pdf',  out: '05-c7-compact7-notice.jpg' },
];
