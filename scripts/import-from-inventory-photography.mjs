// Import universel depuis inventory-photography.json
...
const CAT_ID = '79ea117d-8952-4b9e-aab9-4b10fc2dec7a'; // Photography
const INVENTORY = JSON.parse(readFileSync(
  'C:/Users/adm/Claude Doc GB test/service-manuals-pro/inventory-photography.json', 'utf-8'
));
...
// ── Main ─────────────────────────────────────────────────────────────────────
async function run() {
  console.log('=== Import universel — Photography ===\n');
