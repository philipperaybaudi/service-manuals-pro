...
const batch = docs.slice(400, 482);
...
fs.writeFileSync('batch5-translations.json', JSON.stringify(translations, null, 2));
console.log(`✓ Generated batch5-translations.json with ${translations.length} documents`);
