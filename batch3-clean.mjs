...
// Batch 3: documents 201-300
const batch = docs.slice(200, 300);

// Smart translation mapping for technical documentation
...
fs.writeFileSync('batch3-translations.json', JSON.stringify(translations, null, 2));
console.log(`✓ Generated batch3-translations.json with ${translations.length} documents`);
